...
-- Adding code with individual queries and stored routines.
-- -------------------------------------------------------- USMAN --------------------------------------------------------
...
-- ----------------------------------------------------------------------- Stored routines -----------------------------------------------------------------------
-- This trigger updates the Blood Demand History Table whenever there is a new request added to the requests table
...
SELECT GetDonorImpactScore(2) AS ImpactScore;  --  Calculates and displays the impact score for donor with ID 2

-- ----------------------------------------------------------------------- SAI -----------------------------------------------------------------------
    #Retrieve the count of blood bags available in inventory that are compatible with a specific blood type for transfusion
...
#Identify locations with high demand for a specific blood type over the past year to prioritize inventory restocking
...
#Identify locations with substantial demand for blood type 'A+' in the past year to prioritize inventory allocation
SELECT LocationID, 
       SUM(QuantityDemanded) AS TotalDemand,
       COUNT(*) AS TotalRequests,
       MAX(DemandDate) AS MostRecentRequest
